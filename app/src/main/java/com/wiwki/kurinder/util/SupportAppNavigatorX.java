 ...
 */
public class SupportAppNavigatorX implements Navigator {
    ...
    public SupportAppNavigatorX(FragmentActivity activity, int containerId) {
        this(activity, activity.getSupportFragmentManager(), containerId);
    }

    public SupportAppNavigatorX(FragmentActivity activity, FragmentManager fragmentManager, int containerId) {
    ...
    protected void activityForward(Forward command) {
        SupportAppScreenX screen = (SupportAppScreenX) command.getScreen();
    ...
    protected void backTo(BackTo command) {
        if (command.getScreen() == null) {
            ...
            if (index != -1) {
                ...
                backToUnexisting((SupportAppScreenX) command.getScreen());
            }
        }
    }
    ...
    private void checkAndStartActivity(SupportAppScreenX screen, Intent activityIntent, Bundle options) {
     ...
     */
    protected void unexistingActivity(SupportAppScreenX screen, Intent activityIntent) {
     ...
     */
    protected Fragment createFragment(SupportAppScreenX screen) {
     ...
     * @param screen screen
     */
    protected void backToUnexisting(SupportAppScreenX screen) {
        backToRoot();
    }

    protected void errorWhileCreatingScreen(SupportAppScreenX screen) {
